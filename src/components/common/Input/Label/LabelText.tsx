...
const LabelText = ({ children, htmlFor, className, active, standalone }: LabelTextProps): React.ReactElement => {
    ...
    if (active) {
        labelClass.push('scale-50 translate-x-[1.2rem] font-semibold');
    }
